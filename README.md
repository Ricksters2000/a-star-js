This project is an algorithm visualizer to demonstrate how the A* algorithm works. Open the `index.html` file in a browser or preview it now [here](google.com)
